<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
          ...
          <textarea class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" id="bio" wire:model="state.bio_data" placeholder="Bio Data"></textarea>
         ...
         <div class="col-span-6 sm:col-span-4">
          ...
          <!-- Category -->
          <div class="col-span-6 sm:col-span-4">
            <x-label for="experience" value="{{ __('Category') }}" />
